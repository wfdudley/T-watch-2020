...
// Will display the spot where you touch
// for 120 seconds and then return to time

void appTouch() {
  uint32_t endTime = millis() + 10000; // Timeout at 120 seconds
  int16_t x, y;
  ...
  while (endTime > millis()) {
    ...
    ttgo->tft->println(y);
#else
    ttgo->tft->fillCircle(x, y, 5, TFT_WHITE);
#endif
    delay(25);
  }
